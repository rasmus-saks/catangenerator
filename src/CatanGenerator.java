...
public class CatanGenerator {
    ...
    /**
     * This is where the hexes pick their respective locations from.
     * The locations are generated by the following logic:
     * http://i.imgur.com/RysV0UY.jpg
     * From left to right: the x coordinate
     * From top to bottom: the y coordinate
